...
const  Layout = (props)=> {
    ...
    const sideDrawerToggleHandler = () => {
        setShowSideDrawer(!showSideDrawer);//Một dạng khác của hàm setState nhận đầu vào là một hàm có tham số là state trước thời điểm gọi hàm sideDrawerToggleHandler
    };
